...
// function VideoDetails({ activeVideoId }) {
//   const activeVideo = videosDataDetails.find((video) => video.id === activeVideoId);
//   console.log(activeVideoId)
// 	// console.log(activeVideo)
//   if (!activeVideo) return null;

//   const { title, channel, comments, views, likes, description } = activeVideo;
...
//           <p className="vid-details__description">{activeVideo.description}</p>
//         </div>
//       </div>
//     </section>
//   );
